...
;;---------------------------------------------------------------------------
;; Implementation details from autogenerated subnacl/sexpdefs file
;;
;; sexpdefs contains terms in a little DSL for specifying various
...
;; constructs. Then we include sexpdefs itself.
...
(include "private/subnacl/sexpdefs")
